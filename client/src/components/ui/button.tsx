...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  outline:
    "border border-border bg-background/80 text-foreground shadow-[0_12px_24px_-24px_rgba(41,28,18,0.8)] hover:-translate-y-0.5 hover:border-primary/30 hover:bg-accent/40 hover:text-accent-foreground active:translate-y-0",
  ghost:
